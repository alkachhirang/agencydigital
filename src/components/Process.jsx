        ...
        <div id='Ourprocess' className='py_process process_bg_img'>
            <Container>
                <div className='d-flex justify-content-center align-items-center flex-column pb-4'>
                    <h2 className='ff_dm fw-bold fs_12 text-uppercase text-white how_work text-center m-0 pb-md-3 pb-2'>how it works</h2>
                    <p className='ff_dm text-white fs_48 fw-medium lh_122 text-center m-0 pb-md-4 pb-2'>Our Process</p>
                    <p className='ff_dm fs_20 fw-normal lh_170 text-center text-white mw_718'>We know the best solution for all of your business ideas and we can help you solve all business problems</p>
                </div>
                <div className='business_box mt-2 mb_lg_40'>
                    <Row className=''>
                        ...
                        <Col xl={6} className='col-12 d-flex align-items-center justify-content-center flex-column pb-3 ps-lg-5'>
                            <div>
                                <div className='pb-3'>
                                    <Businessaudit />
                                </div>
                ...
                <div className='business_box mt-4 mb_lg_40'>
                    <Row className=''>
                        <Col xl={6} className='col-11'   >
                            <img src={Result} alt="Result" className='w-100' />
                        </Col>
                        <Col xl={6} className='col-11 d-flex align-items-center justify-content-center flex-column pb-3 ps-lg-5'>
                            <div>
                                <div className='pb-3'>
                                    <ResultsSvg />
                                </div>
