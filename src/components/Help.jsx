...
const Help = () => {
    return (
        <div id='Yourbenefits' className='my_help help_bg_img'>
            <Container>
                <div>
                    <h2 className='ff_dm fs_12 text-uppercase fw-bold brand pb-md-4 pt-3 pt-md-0 text-md-start text-center' data-aos="fade-down">features</h2>
                    <p className='ff_dm fw-medium fs_48 clr_black lh_122 m-0 mw_528 pb-2 text-md-start text-center' data-aos="fade-down">We are here to help you with</p>
                </div>
                <Row className='pt-4 align-items-center justify-content-center'> 
                    <Col lg={4} md={6} className='col-11' data-aos="fade-down-right">
                    ...
                    <Col lg={4} md={6} className='pt-4 pt-md-0 col-11' data-aos="fade-down-right">
                        <div className='helpcard'>
                            <div className='pb-1 cursor_pointer'>
                                <Drive />
                            </div>
                    ...
                    <Col lg={4} md={6} className='pt-4 pt-lg-0 col-11' data-aos="fade-down-right">
                        <div className='helpcard'>
                            <div className='pb-1 cursor_pointer'>
                                <Handle />
                            </div>
                    ...
                    <Col lg={4} md={6} className='pt-4 col-11' data-aos="fade-down-left">
                        <div className='helpcard'>
                            <div className='pb-1 cursor_pointer'>
                                <Ux />
                            </div>
